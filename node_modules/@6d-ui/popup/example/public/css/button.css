...
.custom-btn:hover {
  ...
  box-shadow: 0px 5px 10px 0px rgba(139, 74, 74, 0.1);
}
.custom-btn.custom-btn-primary:hover {
  background-color: #038DEE;
}
.custom-btn.addMargin {
  margin: 0px 8px;
}
.custom-btn.margin-left {
  margin-left: 8px;
}
.custom-btn.margin-right {
  margin-right: 8px;
}
.btn-width-inherit {
  min-width: unset;
