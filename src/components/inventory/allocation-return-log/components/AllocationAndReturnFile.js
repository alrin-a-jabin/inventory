...
function AllocationAndReturnFile(props) {
      ...
      <div className="card__bg">
        <div className="product__master__wrap">
          <ul className="nav nav-pills">
            ...
            <NavLink to={`${url}/list`} activeClassName="active" className="nav-link"> Allocation & Return File Log</NavLink>
            </li> 
          </ul>
...
export default AllocationAndReturnFile;
